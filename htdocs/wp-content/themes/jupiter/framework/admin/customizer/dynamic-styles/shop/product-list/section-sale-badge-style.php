...
$css = '.woocommerce-page ul.products li.product .onsale {';
...
$css .= mk_cs_box_model( 'cs_pl_s_sale_badge_style_box_model' );

$css .= mk_cs_typography( 'cs_pl_s_sale_badge_style_typography' );
