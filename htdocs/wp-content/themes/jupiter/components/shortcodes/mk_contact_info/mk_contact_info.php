...
<div class="widget_contact_info mk-contactinfo-shortcode a_margin-bottom-20 <?php echo esc_attr($visibility); ?> <?php echo esc_attr($el_class); ?>" <?php echo esc_attr(get_schema_markup( 'person' )); ?>>
